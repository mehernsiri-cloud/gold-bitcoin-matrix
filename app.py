...
DYNAMIC_PORTFOLIO_FILE = os.path.join(
    DATA_DIR,
    "portfolio_dynamic.csv"
)

FX_HISTORY_FILE = os.path.join(
    DATA_DIR,
    "eur_aed_history.csv"
)
...
def render_eur_aed_monitor():
    ...
    initial_rate = history_3m[
        "eur_aed"
    ].iloc[0]

    latest_rate = history_3m[
        "eur_aed"
    ].iloc[-1]
